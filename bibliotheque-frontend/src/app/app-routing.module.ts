...
const routes: Routes = [
  ...
  // L'écran a besoin de GET /admin/users pour sa liste d'adhérents, route
  // réservée au rôle Admin : le garde applique ici la même restriction que
  // le serveur, plutôt que de laisser l'utilisateur buter sur un 403.
